    ...
    if not faq:
        faq = [
            ...
            for i, (q, a) in enumerate([
                ("Birinchi tashrif qanday o'tadi?", "Birinchi tashrifda shifokor og'iz bo'shlig'ini ko'rib chiqadi, kerak bo'lsa rentgen olinadi va individual davolash rejasi tuziladi. Bu jarayon odatda 30–40 daqiqa davom etadi."),
                ("Qabul oldin nima qilishim kerak?", "Ilovadagi profilni to'ldiring — shaxsiy, tibbiy va tish tarixi ma'lumotlarini kiriting. Bu shifokorga tashxisni tezroq qo'yishga yordam beradi."),
                ("Narxlar qanday belgilanadi?", "Narxlar xizmat turiga va ishlatilgan materiallarga qarab belgilanadi. Konsultatsiya 100 000 so'mdan boshlanadi. Aniq narxni shifokor ko'rikdan keyin aytadi."),
                ("Bo'lib to'lash mumkinmi?", "Ha, katta summali davolashlar uchun bo'lib to'lash imkoniyati mavjud. Tafsilotlarni qabul vaqtida shifokor bilan kelishishingiz mumkin."),
                ("Profilaktik dastur nima?", "Har 6 oyda bepul profilaktik ko'rik va professional tish tozalash dasturi. Agar ko'rikda aniqlangan kariyes davolansa, keyingi cleaning bepul bo'ladi."),
                ("Profilaktik dasturga qanday qo'shilaman?", "Ilovadagi profilingizni to'liq to'ldiring va 'Qabul' bo'limidan 'Dasturga qo'shilish' tugmasini bosing. Shifokor siz bilan bog'lanib, birinchi tashrif vaqtini belgilaydi."),
                ("Qabulni bekor qilish mumkinmi?", "Ha, qabulni kamida 24 soat oldin bekor qilish kerak. Aks holda profilaktik dastur imtiyozlari ta'sirlanishi mumkin."),
                ("Tish oqartirish xavflimi?", "Professional oqartirish shifokor nazoratida xavfsiz o'tkaziladi. Emal strukturasiga zarar yetkazmaydi, lekin muolaja keyin 48 soat rangli oziq-ovqat va ichimliklardan saqlanish tavsiya etiladi."),
                ("Implant o'rnatish og'riqli bo'ladimi?", "Operatsiya mahalliy anesteziya ostida o'tkaziladi, shuning uchun jarayon og'riqsiz bo'ladi. Operatsiyadan keyin 2–3 kun yengil shishish va noqulaylik bo'lishi mumkin."),
                ("Breket qo'yish qancha davom etadi?", "Breket tizimi odatda 12–24 oy orasida kiyiladi. Aniq muddat tishlar holatiga bog'liq. Har 4–6 haftada tekshiruv amalga oshiriladi."),
                ("Bolalar uchun qabul bormi?", "Ha, biz bolalar stomatologiyasi xizmatini ham ko'rsatamiz. 3 yoshdan boshlab bolalarni profilaktik ko'rikka olib kelish tavsiya etiladi."),
                ("Rentgen xavfsizmi?", "Klinikamizda raqamli rentgen qurilmasi ishlatiladi — an'anaviy rentgenga nisbatan nurlanish 90% kam. Homilador ayollar uchun ehtiyotkorlik sifatida rentgendan vaqtincha voz kechish tavsiya etiladi."),
                ("Tish nervi davolash nima?", "Tish ichidagi yallig'langan yoki kasallangan nervni olib tashlash va kanallarni tozalash jarayoni. Bu tishni sug'urib tashlashdan saqlaydi. Bir yoki bir necha tashrif talab qilishi mumkin."),
                ("Qancha vaqt kutish kerak?", "Biz oldindan qabul vaqtini belgilaymiz, shuning uchun kutish vaqti minimal — odatda 5–10 daqiqa. Shoshilinch holatlarda navbatsiz qabul ham mavjud."),
                ("Allergiyam bo'lsa nima qilaman?", "Profilni to'ldirishda barcha allergiyalarni ko'rsating. Shifokor muqobil materiallar va dorilarni tanlaydi. Har qanday allergiya haqida qabul vaqtida ham aytib o'ting."),
                ("Homiladorlik davrida davolanish mumkinmi?", "Ikkinchi trimestrda ba'zi davolashlar xavfsiz hisoblanadi. Lekin shifokor bilan maslahat qilish shart. Rentgen va ba'zi dorilar homiladorlik davrida qo'llanilmaydi."),
                ("Kafolat beriladi mi?", "Ha, plomba va protezlarga materialga qarab 6 oydan 2 yilgacha kafolat beriladi. Implantlarga esa ishlab chiqaruvchi kafolati amal qiladi."),
                ("Ish vaqtingiz qanday?", "Dushanba–Shanba kunlari soat 9:00 dan 19:00 gacha ishlaymiz. Yakshanba — dam olish kuni. Shoshilinch holatlarda telefon orqali bog'lanishingiz mumkin."),
                ("Klinika qayerda joylashgan?", "Toshkent shahri, Furqat ko'chasi 11a. Metro bekatidan 5 daqiqalik piyoda masofa. Google Maps orqali yo'nalishni olishingiz mumkin."),
